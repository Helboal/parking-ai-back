...
class PaymentController extends Controller
{
     ...
     *     path="/api/admin/payments",
     *     tags={"Payments"},
     *     summary="[MANUAL] Crear un nuevo pago",
     *     description="SOLO PARA PAGOS MANUALES/CORRECCIONES. El flujo normal del parqueadero NO usa este endpoint - los pagos se generan automáticamente en POST /entries/{license_plate}/invoice. Use este endpoint únicamente para: pagos manuales de facturas ya generadas, pagos de suscripciones, o correcciones administrativas. El monto se calcula automáticamente según el balance pendiente de la factura o el monto de la suscripción. El pago se registra como completado con la fecha/hora actual y el usuario autenticado.",
     *     security={{"sanctum":{}}},
     *
     *     @OA\RequestBody(
     *         required=true,
